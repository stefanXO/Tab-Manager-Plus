...
TabManager = function (_React$Component) {_inherits(TabManager, _React$Component);
	function TabManager(props) {_classCallCheck(this, TabManager);var _this7 = _possibleConstructorReturn(this, (TabManager.__proto__ || Object.getPrototypeOf(TabManager)).call(this,
		props));
	...
	}_createClass(TabManager, [{ key: "UNSAFE_componentWillMount", value: function UNSAFE_componentWillMount()
		{
			this.update();
		} }, { key: "loadStorage", value: function () {var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {var layout, animations, windowTitles, compact, dark, tabactions, badge, sessionsFeature, hideWindows, filterTabs, tabLimit, openInOwnTab, tabWidth, tabHeight, storage;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
								...
								openInOwnTab = false;
								tabWidth = 800;
								tabHeight = 600;_context.next = 16;return (

									browser.storage.local.get(null));case 16:storage = _context.sent;
								...
								this.setState({
									...
									hideWindows: hideWindows,
									sessionsFeature: sessionsFeature,
									filterTabs: filterTabs });case 48:case "end":return _context.stop();}}}, _callee, this);}));function loadStorage() {return _ref.apply(this, arguments);}return loadStorage;}() }, { key: "hoverHandler", value: function hoverHandler(
					...
					React.createElement("div", { className: "window placeholder" })));
		...
		} }, { key: "componentDidMount", value: function () {var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {var _this, runUpdate, runTabUpdate;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (



									this.loadStorage());case 2:
								...
								browser.runtime.onMessage.addListener(function (request, sender, sendResponse) {
									...
									switch (request.command) {
										case "refresh_windows":var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
												for (var _iterator = request.window_ids[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var window_id = _step.value;
								...
								setTimeout(_asyncToGenerator(regeneratorRuntime.mark(function _callee2() {var scrollArea, activeWindow, activeTab, animations;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
													scrollArea = document.getElementsByClassName("window-container")[0];
													activeWindow = document.getElementsByClassName("activeWindow");if (!(
													!!activeWindow && activeWindow.length > 0)) {_context2.next = 12;break;}
													activeTab = activeWindow[0].getElementsByClassName("highlighted");if (!(
													!!activeTab && activeTab.length > 0)) {_context2.next = 12;break;}if (!(
													!!scrollArea && scrollArea.scrollTop > 0)) {_context2.next = 8;break;}_context2.next = 12;break;case 8:_context2.next = 10;return (

														getLocalStorage("animations", false));case 10:animations = _context2.sent;
													activeTab[0].scrollIntoView({ behavior: animations ? "smooth" : "instant", block: "center", inline: "nearest" });case 12:case "end":return _context2.stop();}}}, _callee2, this);})),
								...
								250);case 25:case "end":return _context3.stop();}}}, _callee3, this);}));function componentDidMount() {return _ref2.apply(this, arguments);}return componentDidMount;}() }, { key: "sessionSync", value: function () {var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {var values, sessions, key, sess;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
									...
									getLocalStorage('sessions', {}));case 2:values = _context4.sent;
								...
								this.update();case 7:case "end":return _context4.stop();}}}, _callee4, this);}));function sessionSync() {return _ref4.apply(this, arguments);}return sessionSync;}() }, { key: "focusRoot", value: function focusRoot()
		...
		active, windowId) {
			...
			this.forceUpdate();
		} }, { key: "update", value: function () {var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {var windows, sort_windows, tabCount, i, window, j, tab, id;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_context5.next = 2;return (


									browser.windows.getAll({ populate: true }));case 2:windows = _context5.sent;_context5.next = 5;return (
									getLocalStorage("windowAge", []));case 5:sort_windows = _context5.sent;
								...
								this.setState({
									tabCount: tabCount });case 16:case "end":return _context5.stop();}}}, _callee5, this);}));function update() {return _ref5.apply(this, arguments);}return update;}() }, { key: "deleteTabs", value: function () {var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {var _this2, tabs, t;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
								...
								tabs.length) {_context6.next = 6;break;}
								browser.runtime.sendMessage({ command: "close_tabs", tabs: tabs });_context6.next = 12;break;case 6:_context6.next = 8;return (

									browser.tabs.query({ currentWindow: true, active: true }));case 8:t = _context6.sent;if (!(
								t && t.length > 0)) {_context6.next = 12;break;}_context6.next = 12;return (
									browser.tabs.remove(t[0].id));case 12:


								this.forceUpdate();case 13:case "end":return _context6.stop();}}}, _callee6, this);}));function deleteTabs() {return _ref6.apply(this, arguments);}return deleteTabs;}() }, { key: "deleteTab", value: function deleteTab(

		tabId) {
			browser.tabs.remove(tabId);
		} }, { key: "discardTabs", value: function () {var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {var _this2, tabs;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:
								...
								this.clearSelection();case 4:case "end":return _context7.stop();}}}, _callee7, this);}));function discardTabs() {return _ref7.apply(this, arguments);}return discardTabs;}() }, { key: "discardTab", value: function discardTab(

		tabId) {
			browser.tabs.discard(tabId);
		} }, { key: "addWindow", value: function () {var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8() {var _this3, count, tabs;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
								...
								count == 0)) {_context8.next = 8;break;}_context8.next = 6;return (
									browser.windows.create({}));case 6:_context8.next = 9;break;case 8:
								if (count == 1) {
									if (navigator.userAgent.search("Firefox") > -1) {
								...
								if (!!window.inPopup) window.close();case 10:case "end":return _context8.stop();}}}, _callee8, this);}));function addWindow() {return _ref8.apply(this, arguments);}return addWindow;}() }, { key: "pinTabs", value: function () {var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9() {var _this4, tabs, i, t;return regeneratorRuntime.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:
								...
								tabs.length) {_context9.next = 13;break;}
								if (tabs[0].pinned) tabs.reverse();
								i = 0;case 5:if (!(i < tabs.length)) {_context9.next = 11;break;}_context9.next = 8;return (
									browser.tabs.update(tabs[i].id, { pinned: !tabs[0].pinned }));case 8:i++;_context9.next = 5;break;case 11:_context9.next = 19;break;case 13:_context9.next = 15;return (


									browser.tabs.query({ currentWindow: true, active: true }));case 15:t = _context9.sent;if (!(
								t && t.length > 0)) {_context9.next = 19;break;}_context9.next = 19;return (
									browser.tabs.update(t[0].id, { pinned: !t[0].pinned }));case 19:case "end":return _context9.stop();}}}, _callee9, this);}));function pinTabs() {return _ref9.apply(this, arguments);}return pinTabs;}() }, { key: "highlightDuplicates", value: function highlightDuplicates(
		...
		e) {
			...
			if (!searchLen) {
				...
				for (var id in idList) {
					...
					if (searchType == "normal") {
					...
					} else if (searchType == "OR") {var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
							for (var _iterator2 = searchTerms[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var searchOR = _step2.value;
						...
						var andMatch = true;var _iteratorNormalCompletion3 = true;var _didIteratorError3 = false;var _iteratorError3 = undefined;try {
							for (var _iterator3 = searchTerms[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {var searchAND = _step3.value;
					...
					if (goLeft || goRight) {
						...
						if (!altKey && selectedTabs.length > 1) {
							...
							if (!this.state.lastDirection) {
								...
								}} catch (err) {_didIteratorError4 = true;_iteratorError4 = err;} finally {try {if (!_iteratorNormalCompletion4 && _iterator4.return) {_iterator4.return();}} finally {if (_didIteratorError4) {throw _iteratorError4;}}}var _iteratorNormalCompletion5 = true;var _didIteratorError5 = false;var _iteratorError5 = undefined;try {
								for (var _iterator5 = this.state.windows[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {var _w = _step5.value;
									if (found) break;
									if (_w.state == "minimized") {var _iteratorNormalCompletion7 = true;var _didIteratorError7 = false;var _iteratorError7 = undefined;try {
						...
						if (selectedTabs.length > 1) {
							...
							if (selectedTabs.length == 1) {
								...
								for (var _iterator9 = this.state.windows[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {var _w = _step9.value;
									...
									if (found) break;
									if (_w.state == "minimized") {
										if (!first) first = _w.id;var _iteratorNormalCompletion11 = true;var _didIteratorError11 = false;var _iteratorError11 = undefined;try {
											for (var _iterator11 = _w.tabs[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {var _t = _step11.value;
												i++;
												last = _w.id;
												if (!selectedTab) {
													this.selectWindowTab(_w.id, tabPosition);
		...
		windowId, tabPosition) {
			if (!tabPosition || tabPosition < 1) tabPosition = 1;var _iteratorNormalCompletion12 = true;var _didIteratorError12 = false;var _iteratorError12 = undefined;try {
				for (var _iterator12 = this.state.windows[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {var _w = _step12.value;
					if (_w.id != windowId) continue;
					var i = 0;var _iteratorNormalCompletion13 = true;var _didIteratorError13 = false;var _iteratorError13 = undefined;try {
						for (var _iterator13 = _w.tabs[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {var _t = _step13.value;
							i++;
		...
		} }, { key: "changelayout", value: function () {var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(
			layout) {var newLayout;return regeneratorRuntime.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:
								...
								this.state.layout = newLayout;_context10.next = 4;return (
									setLocalStorage("layout", newLayout));case 4:
								...
								this.forceUpdate();case 6:case "end":return _context10.stop();}}}, _callee10, this);}));function changelayout(_x) {return _ref10.apply(this, arguments);}return changelayout;}() }, { key: "nextlayout", value: function nextlayout()
		...
		e, id) {
			...
			this.forceUpdate();
		} }, { key: "drop", value: function () {var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee11(
			id, before) {var _this5, tab, tabs, index, i, t;return regeneratorRuntime.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:
								_this5 = this;
								...
								i = 0;case 5:if (!(i < tabs.length)) {_context11.next = 14;break;}
								t = tabs[i];_context11.next = 9;return (
									browser.tabs.move(t.id, { windowId: tab.windowId, index: index }));case 9:_context11.next = 11;return (
									browser.tabs.update(t.id, { pinned: t.pinned }));case 11:i++;_context11.next = 5;break;case 14:

								this.setState({
									selection: {} });

								this.update();case 16:case "end":return _context11.stop();}}}, _callee11, this);}));function drop(_x2, _x3) {return _ref11.apply(this, arguments);}return drop;}() }, { key: "dropWindow", value: function () {var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(

			windowId) {var _this6, tabs;return regeneratorRuntime.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:
								_this6 = this;
								tabs = Object.keys(this.state.selection).map(function (id) {
								...
								this.setState({
									selection: {} });case 4:case "end":return _context12.stop();}}}, _callee12, this);}));function dropWindow(_x4) {return _ref12.apply(this, arguments);}return dropWindow;}() }, { key: "changeTabLimit", value: function () {var _ref13 = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(


			e) {return regeneratorRuntime.wrap(function _callee13$(_context13) {while (1) {switch (_context13.prev = _context13.next) {case 0:
								this.state.tabLimit = e.target.value;_context13.next = 3;return (
									setLocalStorage("tabLimit", this.state.tabLimit));case 3:
								this.tabLimitText();
								this.forceUpdate();case 5:case "end":return _context13.stop();}}}, _callee13, this);}));function changeTabLimit(_x5) {return _ref13.apply(this, arguments);}return changeTabLimit;}() }, { key: "tabLimitText", value: function tabLimitText()

		{
			this.setState({
				bottomText: "Limit the number of tabs per window. Will move new tabs into a new window instead. 0 to turn off" });

		} }, { key: "changeTabWidth", value: function () {var _ref14 = _asyncToGenerator(regeneratorRuntime.mark(function _callee14(
			e) {return regeneratorRuntime.wrap(function _callee14$(_context14) {while (1) {switch (_context14.prev = _context14.next) {case 0:
								this.state.tabWidth = e.target.value;_context14.next = 3;return (
									setLocalStorage("tabWidth", this.state.tabWidth));case 3:
								document.body.style.width = this.state.tabWidth + "px";
								this.tabWidthText();
								this.forceUpdate();case 6:case "end":return _context14.stop();}}}, _callee14, this);}));function changeTabWidth(_x6) {return _ref14.apply(this, arguments);}return changeTabWidth;}() }, { key: "tabWidthText", value: function tabWidthText()

		{
			this.setState({
				bottomText: "Change the width of this window. 800 by default." });

		} }, { key: "changeTabHeight", value: function () {var _ref15 = _asyncToGenerator(regeneratorRuntime.mark(function _callee15(
			e) {return regeneratorRuntime.wrap(function _callee15$(_context15) {while (1) {switch (_context15.prev = _context15.next) {case 0:
								this.state.tabHeight = e.target.value;_context15.next = 3;return (
									setLocalStorage("tabHeight", this.state.tabHeight));case 3:
								document.body.style.height = this.state.tabHeight + "px";
								this.tabHeightText();
								this.forceUpdate();case 6:case "end":return _context15.stop();}}}, _callee15, this);}));function changeTabHeight(_x7) {return _ref15.apply(this, arguments);}return changeTabHeight;}() }, { key: "tabHeightText", value: function tabHeightText()

		{
			this.setState({
				bottomText: "Change the height of this window. 600 by default." });

		} }, { key: "toggleAnimations", value: function () {var _ref16 = _asyncToGenerator(regeneratorRuntime.mark(function _callee16() {return regeneratorRuntime.wrap(function _callee16$(_context16) {while (1) {switch (_context16.prev = _context16.next) {case 0:

								this.state.animations = !this.state.animations;_context16.next = 3;return (
									setLocalStorage("animations", this.state.animations));case 3:
								this.animationsText();
								this.forceUpdate();case 5:case "end":return _context16.stop();}}}, _callee16, this);}));function toggleAnimations() {return _ref16.apply(this, arguments);}return toggleAnimations;}() }, { key: "animationsText", value: function animationsText()

		{
			this.setState({
				bottomText: "Enables/disables animations. Default : on" });

		} }, { key: "toggleWindowTitles", value: function () {var _ref17 = _asyncToGenerator(regeneratorRuntime.mark(function _callee17() {return regeneratorRuntime.wrap(function _callee17$(_context17) {while (1) {switch (_context17.prev = _context17.next) {case 0:

								this.state.windowTitles = !this.state.windowTitles;_context17.next = 3;return (
									setLocalStorage("windowTitles", this.state.windowTitles));case 3:
								this.windowTitlesText();
								this.forceUpdate();case 5:case "end":return _context17.stop();}}}, _callee17, this);}));function toggleWindowTitles() {return _ref17.apply(this, arguments);}return toggleWindowTitles;}() }, { key: "windowTitlesText", value: function windowTitlesText()

		{
			this.setState({
				bottomText: "Enables/disables window titles. Default : on" });

		} }, { key: "toggleCompact", value: function () {var _ref18 = _asyncToGenerator(regeneratorRuntime.mark(function _callee18() {return regeneratorRuntime.wrap(function _callee18$(_context18) {while (1) {switch (_context18.prev = _context18.next) {case 0:

								this.state.compact = !this.state.compact;_context18.next = 3;return (
									setLocalStorage("compact", this.state.compact));case 3:
								this.compactText();
								this.forceUpdate();case 5:case "end":return _context18.stop();}}}, _callee18, this);}));function toggleCompact() {return _ref18.apply(this, arguments);}return toggleCompact;}() }, { key: "compactText", value: function compactText()

		{
			this.setState({
				bottomText: "Compact mode is a more compressed layout. Default : off" });

		} }, { key: "toggleDark", value: function () {var _ref19 = _asyncToGenerator(regeneratorRuntime.mark(function _callee19() {return regeneratorRuntime.wrap(function _callee19$(_context19) {while (1) {switch (_context19.prev = _context19.next) {case 0:

								this.state.dark = !this.state.dark;_context19.next = 3;return (
									setLocalStorage("dark", this.state.dark));case 3:
								this.darkText();
								if (this.state.dark) {
									document.body.className = "dark";
								...
								this.forceUpdate();case 6:case "end":return _context19.stop();}}}, _callee19, this);}));function toggleDark() {return _ref19.apply(this, arguments);}return toggleDark;}() }, { key: "darkText", value: function darkText()

		{
			this.setState({
				bottomText: "Dark mode inverts the layout - better on the eyes. Default : off" });

		} }, { key: "toggleTabActions", value: function () {var _ref20 = _asyncToGenerator(regeneratorRuntime.mark(function _callee20() {return regeneratorRuntime.wrap(function _callee20$(_context20) {while (1) {switch (_context20.prev = _context20.next) {case 0:

								this.state.tabactions = !this.state.tabactions;_context20.next = 3;return (
									setLocalStorage("tabactions", this.state.tabactions));case 3:
								this.tabActionsText();
								this.forceUpdate();case 5:case "end":return _context20.stop();}}}, _callee20, this);}));function toggleTabActions() {return _ref20.apply(this, arguments);}return toggleTabActions;}() }, { key: "tabActionsText", value: function tabActionsText()

		{
			this.setState({
				bottomText: "Adds 'Open a new tab' and 'Close this window' option to each window. Default : on" });

		} }, { key: "toggleBadge", value: function () {var _ref21 = _asyncToGenerator(regeneratorRuntime.mark(function _callee21() {return regeneratorRuntime.wrap(function _callee21$(_context21) {while (1) {switch (_context21.prev = _context21.next) {case 0:

								this.state.badge = !this.state.badge;_context21.next = 3;return (
									setLocalStorage("badge", this.state.badge));case 3:
								this.badgeText();
								browser.runtime.sendMessage({ command: "update_tab_count" });
								this.forceUpdate();case 6:case "end":return _context21.stop();}}}, _callee21, this);}));function toggleBadge() {return _ref21.apply(this, arguments);}return toggleBadge;}() }, { key: "badgeText", value: function badgeText()

		{
			this.setState({
				bottomText: "Shows the number of open tabs on the Tab Manager icon. Default : on" });

		} }, { key: "toggleOpenInOwnTab", value: function () {var _ref22 = _asyncToGenerator(regeneratorRuntime.mark(function _callee22() {return regeneratorRuntime.wrap(function _callee22$(_context22) {while (1) {switch (_context22.prev = _context22.next) {case 0:

								this.state.openInOwnTab = !this.state.openInOwnTab;_context22.next = 3;return (
									setLocalStorage("openInOwnTab", this.state.openInOwnTab));case 3:
								this.openInOwnTabText();
								browser.runtime.sendMessage({ command: "reload_popup_controls" });
								this.forceUpdate();case 6:case "end":return _context22.stop();}}}, _callee22, this);}));function toggleOpenInOwnTab() {return _ref22.apply(this, arguments);}return toggleOpenInOwnTab;}() }, { key: "openInOwnTabText", value: function openInOwnTabText()

		{
			this.setState({
				bottomText: "Open the Tab Manager by default in own tab, or as a popup?" });

		} }, { key: "toggleSessions", value: function () {var _ref23 = _asyncToGenerator(regeneratorRuntime.mark(function _callee23() {return regeneratorRuntime.wrap(function _callee23$(_context23) {while (1) {switch (_context23.prev = _context23.next) {case 0:

								this.state.sessionsFeature = !this.state.sessionsFeature;_context23.next = 3;return (
									setLocalStorage("sessionsFeature", this.state.sessionsFeature));case 3:
								this.sessionsText();
								this.forceUpdate();case 5:case "end":return _context23.stop();}}}, _callee23, this);}));function toggleSessions() {return _ref23.apply(this, arguments);}return toggleSessions;}() }, { key: "sessionsText", value: function sessionsText()
		...
		evt) {var _this8 = this;
			...
			try {
				...
				var self = this;
				reader.onload = function () {var _ref24 = _asyncToGenerator(regeneratorRuntime.mark(function _callee24(event) {var backupFile, success, i, newSession, sessions, value;return regeneratorRuntime.wrap(function _callee24$(_context24) {while (1) {switch (_context24.prev = _context24.next) {case 0:
										...
										!!backupFile && backupFile.length > 0)) {_context24.next = 20;break;}
										success = backupFile.length;
										i = 0;case 4:if (!(i < backupFile.length)) {_context24.next = 17;break;}
										newSession = backupFile[i];if (!(
										newSession.windowsInfo && newSession.tabs && newSession.id)) {_context24.next = 14;break;}_context24.next = 9;return (
											getLocalStorage('sessions', {}));case 9:sessions = _context24.sent;
										sessions[newSession.id] = newSession;_context24.next = 13;return (
											...
											setLocalStorage('sessions', sessions).catch(function (err) {
												...
												success--;
											}));case 13:value = _context24.sent;case 14:i++;_context24.next = 4;break;case 17:



										_this8.setState({ bottomText: success + " windows successfully restored!" });_context24.next = 21;break;case 20:

										_this8.setState({ bottomText: "Error: Could not restore any windows from the backup file!" });case 21:

										inputField.value = "";
										_this8.sessionSync();case 23:case "end":return _context24.stop();}}}, _callee24, _this8);}));return function (_x8) {return _ref24.apply(this, arguments);};}();
		...
		} }, { key: "toggleHide", value: function () {var _ref25 = _asyncToGenerator(regeneratorRuntime.mark(function _callee25() {var granted;return regeneratorRuntime.wrap(function _callee25$(_context25) {while (1) {switch (_context25.prev = _context25.next) {case 0:if (!(


								navigator.userAgent.search("Firefox") > -1)) {_context25.next = 4;break;}
								this.state.hideWindows = false;_context25.next = 8;break;case 4:_context25.next = 6;return (

									browser.permissions.request({ permissions: ["system.display"] }));case 6:granted = _context25.sent;
								if (granted) {
									this.state.hideWindows = !this.state.hideWindows;
								} else {
									this.state.hideWindows = false;
								}case 8:_context25.next = 10;return (


									setLocalStorage("hideWindows", this.state.hideWindows));case 10:
								this.hideText();
								this.forceUpdate();case 12:case "end":return _context25.stop();}}}, _callee25, this);}));function toggleHide() {return _ref25.apply(this, arguments);}return toggleHide;}() }, { key: "hideText", value: function hideText()

		{
			this.setState({
				bottomText: "Automatically minimizes inactive chrome windows. Default : off" });

		} }, { key: "toggleFilterMismatchedTabs", value: function () {var _ref26 = _asyncToGenerator(regeneratorRuntime.mark(function _callee26() {return regeneratorRuntime.wrap(function _callee26$(_context26) {while (1) {switch (_context26.prev = _context26.next) {case 0:

								this.state.filterTabs = !this.state.filterTabs;_context26.next = 3;return (
									setLocalStorage("filter-tabs", this.state.filterTabs));case 3:
								this.forceUpdate();case 4:case "end":return _context26.stop();}}}, _callee26, this);}));function toggleFilterMismatchedTabs() {return _ref26.apply(this, arguments);}return toggleFilterMismatchedTabs;}() }, { key: "getTip", value: function getTip()
