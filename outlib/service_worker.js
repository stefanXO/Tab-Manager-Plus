...
"use strict";function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};}var getLocalStorage = function () {var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(key) {return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:return _context.abrupt("return",
						...
						}));case 1:case "end":return _context.stop();}}}, _callee, undefined);}));return function getLocalStorage(_x) {return _ref.apply(this, arguments);};}();


var setLocalStorage = function () {var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(key, value) {var obj;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
						obj = {};
						obj[key] = value;return _context2.abrupt("return",
						browser.storage.local.set(obj));case 3:case "end":return _context2.stop();}}}, _callee2, undefined);}));return function setLocalStorage(_x2, _x3) {return _ref2.apply(this, arguments);};}();


var removeLocalStorage = function () {var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(key) {return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:return _context3.abrupt("return",
						browser.storage.local.remove(key));case 1:case "end":return _context3.stop();}}}, _callee3, undefined);}));return function removeLocalStorage(_x4) {return _ref3.apply(this, arguments);};}();  
"use strict";var createWindowWithTabs = function () {var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee2(tabs, isIncognito) {var pinnedIndex, firstTab, t, i, firstPinned, w, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, oldTabId, oldTab, tabPinned, movedTabs, newTab;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
						...
						;case 60:_context2.next = 62;return (
							...
							browser.windows.update(w.id, { focused: true }));case 62:case "end":return _context2.stop();}}}, _callee2, this, [[18, 47, 51, 59], [52,, 54, 58]]);}));return function createWindowWithTabs(_x, _x2) {return _ref2.apply(this, arguments);};}();var createWindowWithSessionTabs = function () {var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(


	function _callee3(window) {var customName, whitelistWindow, whitelistTab, filteredWindow, newWindow, emptyTab, i, newTab, tabCreated, names;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
						...
						console.log("filtered window", filteredWindow);_context3.next = 10;return (

							browser.windows.create(filteredWindow).catch(function (error) {
								console.error(error);
								console.log(error);
								console.log(error.message);
							}));case 10:newWindow = _context3.sent;

						emptyTab = newWindow.tabs[0].id;

						i = 0;case 13:if (!(i < window.tabs.length)) {_context3.next = 31;break;}
						...
						newTab.windowId = newWindow.id;_context3.prev = 18;_context3.next = 21;return (

							browser.tabs.create(newTab).catch(function (error) {
								console.error(error);
								console.log(error);
								console.log(error.message);
							}));case 21:tabCreated = _context3.sent;_context3.next = 28;break;case 24:_context3.prev = 24;_context3.t0 = _context3["catch"](18);

						console.log("couldn't restore tab");
						console.error(_context3.t0);case 28:i++;_context3.next = 13;break;case 31:_context3.next = 33;return (
						...
						customName) {_context3.next = 41;break;}_context3.next = 36;return (
							getLocalStorage("windowNames"));case 36:names = _context3.sent;
						if (!!names) {
							names = JSON.parse(names);
						} else {
							names = {};
						}
						names[newWindow.id] = customName || "";_context3.next = 41;return (
							setLocalStorage("windowNames", JSON.stringify(names)));case 41:_context3.next = 43;return (


							browser.windows.update(newWindow.id, { focused: true }));case 43:case "end":return _context3.stop();}}}, _callee3, this, [[18, 24]]);}));return function createWindowWithSessionTabs(_x3) {return _ref3.apply(this, arguments);};}();var focusOnTabAndWindow = function () {var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee4(tab) {var windowId, tabId;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
						...
						}.bind(this, tabId, windowId));case 3:case "end":return _context4.stop();}}}, _callee4, this);}));return function focusOnTabAndWindow(_x4) {return _ref4.apply(this, arguments);};}();var updateTabCount = function () {var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee5() {var run, badge, result, count, toRemove, i, t, found, j;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
						run = true;if (!
						localStorageAvailable()) {_context5.next = 10;break;}_context5.next = 4;return (
							getLocalStorage("badge"));case 4:badge = _context5.sent;if (!(
						typeof badge === "undefined")) {_context5.next = 9;break;}
						badge = "1";_context5.next = 9;return (
							setLocalStorage("badge", badge));case 9:

						if (badge == "0") run = false;case 10:if (!


						run) {_context5.next = 26;break;}_context5.next = 13;return (
							browser.tabs.query({}));case 13:result = _context5.sent;
						count = 0;
						if (!!result && !!result.length) {
							count = result.length;
						}_context5.next = 18;return (
							browser.action.setBadgeText({ text: count + "" }));case 18:_context5.next = 20;return (
						...
						};_context5.next = 28;break;case 26:_context5.next = 28;return (

							browser.action.setBadgeText({ text: "" }));case 28:case "end":return _context5.stop();}}}, _callee5, this);}));return function updateTabCount() {return _ref5.apply(this, arguments);};}();var tabAdded = function () {var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee6(tab) {var tL, tabLimit, tabCount;return regeneratorRuntime.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:_context6.next = 2;return (
							getLocalStorage("tabLimit"));case 2:tL = _context6.sent;if (!(
						typeof tL === "undefined" || tL == null)) {_context6.next = 7;break;}
						tL = "0";_context6.next = 7;return (
						...
						tabLimit > 0)) {_context6.next = 16;break;}if (!(
						tab.id != browser.tabs.TAB_ID_NONE)) {_context6.next = 16;break;}_context6.next = 12;return (
							browser.tabs.query({ currentWindow: true }));case 12:tabCount = _context6.sent;if (!(
						tabCount.length > tabLimit)) {_context6.next = 16;break;}_context6.next = 16;return (
							createWindowWithTabs([tab], tab.incognito));case 16:



						updateTabCountDebounce();case 17:case "end":return _context6.stop();}}}, _callee6, this);}));return function tabAdded(_x5) {return _ref6.apply(this, arguments);};}();var openSidebar = function () {var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee7() {return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:_context7.next = 2;return (
							browser.sidebarAction.open());case 2:case "end":return _context7.stop();}}}, _callee7, this);}));return function openSidebar() {return _ref7.apply(this, arguments);};}();var openPopup = function () {var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(


	function _callee8() {var openInOwnTabValue, openInOwnTab;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:_context8.next = 2;return (

							getLocalStorage("openInOwnTab"));case 2:openInOwnTabValue = _context8.sent;if (!(
						typeof openInOwnTabValue === "undefined")) {_context8.next = 7;break;}
						openInOwnTabValue = "0";_context8.next = 7;return (
						...
						openInOwnTab) {_context8.next = 18;break;}_context8.next = 12;return (
							browser.action.setPopup({ popup: "popup.html?popup=true" }));case 12:_context8.next = 14;return (
							browser.action.openPopup());case 14:_context8.next = 16;return (
							browser.action.setPopup({ popup: "" }));case 16:_context8.next = 20;break;case 18:_context8.next = 20;return (

							browser.action.openPopup());case 20:case "end":return _context8.stop();}}}, _callee8, this);}));return function openPopup() {return _ref8.apply(this, arguments);};}();var openAsOwnTab = function () {var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(



	function _callee9() {var popup_page, tabs, currentTab, previousTab, i, tab;return regeneratorRuntime.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:
						popup_page = browser.runtime.getURL("popup.html");_context9.next = 3;return (
							browser.tabs.query({}));case 3:tabs = _context9.sent;
						...
						i = 0;case 6:if (!(i < tabs.length)) {_context9.next = 17;break;}
						tab = tabs[i];if (!(
						tab.url.indexOf("popup.html") > -1 && tab.url.indexOf(popup_page) > -1)) {_context9.next = 14;break;}if (!(
						currentTab && currentTab.tabId && tab.id == currentTab.tabId && previousTab && previousTab.tabId)) {_context9.next = 13;break;}return _context9.abrupt("return",
						focusOnTabAndWindow(previousTab));case 13:return _context9.abrupt("return",

						browser.windows.update(tab.windowId, { focused: true }).then(
						function () {
							browser.tabs.highlight({ windowId: tab.windowId, tabs: tab.index });
						}.bind(this)));case 14:i++;_context9.next = 6;break;case 17:return _context9.abrupt("return",




						browser.tabs.create({ url: "popup.html" }));case 18:case "end":return _context9.stop();}}}, _callee9, this);}));return function openAsOwnTab() {return _ref9.apply(this, arguments);};}();var setupPopup = function () {var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(


	function _callee10() {var openInOwnTabValue, openInOwnTab;return regeneratorRuntime.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:_context10.next = 2;return (

							getLocalStorage("openInOwnTab"));case 2:openInOwnTabValue = _context10.sent;if (!(
						typeof openInOwnTabValue === "undefined")) {_context10.next = 7;break;}
						openInOwnTabValue = "0";_context10.next = 7;return (
							setLocalStorage("openInOwnTab", openInOwnTabValue));case 7:
						...
						try {
							...
							openInOwnTab = false;
						}_context10.next = 11;return (

							browser.action.onClicked.removeListener(openAsOwnTab));case 11:if (!
						openInOwnTab) {_context10.next = 18;break;}_context10.next = 14;return (
							browser.action.setPopup({ popup: "" }));case 14:_context10.next = 16;return (
							browser.action.onClicked.addListener(openAsOwnTab));case 16:_context10.next = 20;break;case 18:_context10.next = 20;return (
						...
						}case 21:case "end":return _context10.stop();}}}, _callee10, this);}));return function setupPopup() {return _ref10.apply(this, arguments);};}();var setupListeners = function () {var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(


	function _callee11() {return regeneratorRuntime.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:_context11.next = 2;return (
						...
						setTimeout(cleanUp, 5000);case 43:case "end":return _context11.stop();}}}, _callee11, this);}));return function setupListeners() {return _ref11.apply(this, arguments);};}();var checkLocalStorageAvailable = function () {var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee12() {var test;return regeneratorRuntime.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:
						test = 'test';_context12.prev = 1;_context12.next = 4;return (

							setLocalStorage(test, test));case 4:_context12.next = 6;return (
							removeLocalStorage(test));case 6:
						console.log("local storage available");
						globalLocalStorageAvailable = true;return _context12.abrupt("return",
						true);case 11:_context12.prev = 11;_context12.t0 = _context12["catch"](1);

						console.log(_context12.t0);
						console.log("no local storage");
						globalLocalStorageAvailable = false;return _context12.abrupt("return",
						false);case 17:case "end":return _context12.stop();}}}, _callee12, this, [[1, 11]]);}));return function checkLocalStorageAvailable() {return _ref12.apply(this, arguments);};}();var hideWindows = function () {var _ref13 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee14(windowId) {var hideWindows, result;return regeneratorRuntime.wrap(function _callee14$(_context14) {while (1) {switch (_context14.prev = _context14.next) {case 0:if (!(
						navigator.userAgent.search("Firefox") > -1)) {_context14.next = 2;break;}return _context14.abrupt("return");case 2:if (!(



						!windowId || windowId < 0)) {_context14.next = 6;break;}return _context14.abrupt("return");case 6:if (!


						localStorageAvailable()) {_context14.next = 15;break;}
						hideWindows = getLocalStorage("hideWindows") || "0";
						if (typeof hideWindows === "undefined") hideWindows = "0";_context14.next = 11;return (
							setLocalStorage("hideWindows", hideWindows));case 11:if (!(
						hideWindows == "0")) {_context14.next = 13;break;}return _context14.abrupt("return");case 13:_context14.next = 16;break;case 15:return _context14.abrupt("return");case 16:_context14.next = 18;return (




							browser.permissions.contains({ permissions: ['system.display'] }));case 18:result = _context14.sent;
						if (result) {

							chrome.system.display.getInfo(function () {var _ref14 = _asyncToGenerator(regeneratorRuntime.mark(function _callee13(windowId, displaylayouts) {var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, displaylayout, windows, monitor, i, a, result;return regeneratorRuntime.wrap(function _callee13$(_context13) {while (1) {switch (_context13.prev = _context13.next) {case 0:
													globalDisplayInfo = [];
													_iteratorNormalCompletion = true;
													_didIteratorError = false;
													_iteratorError = undefined;_context13.prev = 4;
													...
													}_context13.next = 12;break;case 8:_context13.prev = 8;_context13.t0 = _context13["catch"](4);

													_didIteratorError = true;
													_iteratorError = _context13.t0;case 12:_context13.prev = 12;_context13.prev = 13;


													if (!_iteratorNormalCompletion && _iterator.return) {
														_iterator.return();
													}case 15:_context13.prev = 15;if (!

													_didIteratorError) {_context13.next = 18;break;}throw (
														_iteratorError);case 18:return _context13.finish(15);case 19:return _context13.finish(12);case 20:_context13.next = 22;return (



														browser.windows.getAll({ populate: true }));case 22:windows = _context13.sent;
													monitor = -1;
													...
													i = windows.length - 1;case 27:if (!(i >= 0)) {_context13.next = 35;break;}if (!(
													windows[i].id != windowId)) {_context13.next = 32;break;}if (!
													is_in_bounds(windows[i], globalDisplayInfo[monitor])) {_context13.next = 32;break;}_context13.next = 32;return (
														browser.windows.update(windows[i].id, { "state": "minimized" }));case 32:i--;_context13.next = 27;break;case 35:


													;case 36:case "end":return _context13.stop();}}}, _callee13, this, [[4, 8, 12, 20], [13,, 15, 19]]);}));return function (_x7, _x8) {return _ref14.apply(this, arguments);};}().
							bind(null, windowId));
						}case 20:case "end":return _context14.stop();}}}, _callee14, this);}));return function hideWindows(_x6) {return _ref13.apply(this, arguments);};}();var windowActive = function () {var _ref15 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee15(windowId) {var windows, windowAge;return regeneratorRuntime.wrap(function _callee15$(_context15) {while (1) {switch (_context15.prev = _context15.next) {case 0:if (!(
						windowId < 0)) {_context15.next = 2;break;}return _context15.abrupt("return");case 2:

						windows = [];if (!
						localStorageAvailable()) {_context15.next = 9;break;}_context15.next = 6;return (
							getLocalStorage("windowAge"));case 6:windowAge = _context15.sent;
						...
						windows.unshift(windowId);_context15.next = 13;return (
							setLocalStorage("windowAge", JSON.stringify(windows)));case 13:case "end":return _context15.stop();}}}, _callee15, this);}));return function windowActive(_x9) {return _ref15.apply(this, arguments);};}();var cleanUp = function () {var _ref17 = _asyncToGenerator(regeneratorRuntime.mark(
	...
	function _callee17() {var activewindows, windowids, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, w, windowAge, windows, i, names, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, id;return regeneratorRuntime.wrap(function _callee17$(_context17) {while (1) {switch (_context17.prev = _context17.next) {case 0:_context17.next = 2;return (
							browser.windows.getAll({ populate: true }));case 2:activewindows = _context17.sent;
						windowids = [];_iteratorNormalCompletion3 = true;_didIteratorError3 = false;_iteratorError3 = undefined;_context17.prev = 7;
						for (_iterator3 = activewindows[Symbol.iterator](); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {w = _step3.value;
							windowids.push(w.id);
						}_context17.next = 15;break;case 11:_context17.prev = 11;_context17.t0 = _context17["catch"](7);_didIteratorError3 = true;_iteratorError3 = _context17.t0;case 15:_context17.prev = 15;_context17.prev = 16;if (!_iteratorNormalCompletion3 && _iterator3.return) {_iterator3.return();}case 18:_context17.prev = 18;if (!_didIteratorError3) {_context17.next = 21;break;}throw _iteratorError3;case 21:return _context17.finish(18);case 22:return _context17.finish(15);case 23:_context17.next = 25;return (


							getLocalStorage("windowAge"));case 25:windowAge = _context17.sent;
						...
						};_context17.next = 32;return (

							setLocalStorage("windowAge", JSON.stringify(windows)));case 32:_context17.next = 34;return (

							getLocalStorage("windowNames"));case 34:names = _context17.sent;
						if (!!names) {
							names = JSON.parse(names);
						} else {
							names = {};
						}_iteratorNormalCompletion4 = true;_didIteratorError4 = false;_iteratorError4 = undefined;_context17.prev = 39;
