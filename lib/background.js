...
async function setupListeners() {
	...
	browser.tabs.onCreated.addListener(tabAdded); // 1, tab
	browser.tabs.onUpdated.addListener(tabCountChanged); // 3, tabid, changeinfo, tab
	browser.tabs.onRemoved.addListener(tabCountChanged); // 2, tabid, removeinfo
	browser.tabs.onReplaced.addListener(tabCountChanged); // 2, addedTabId, removedTabId
	browser.tabs.onDetached.addListener(tabCountChanged); // 2, tabid, detachinfo
	browser.tabs.onAttached.addListener(tabCountChanged); // 2, tabid, attachinfo
	browser.tabs.onActivated.addListener(tabActiveChanged); // 1, activeInfo
	browser.tabs.onMoved.addListener(tabCountChanged); // 2, tabid, moveinfo
