var TabManager = React.createFactory(React.createClass({
	getInitialState:function(){
		...
		if(this.localStorageAvailable()) {
			...
			if(typeof localStorage["version"] === "undefined") localStorage["version"] = "4.9.2";
