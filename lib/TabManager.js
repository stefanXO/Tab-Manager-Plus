...
class TabManager extends React.Component {
	...
	componentDidMount() {
		...
		browser.tabs.onCreated.addListener(this.update);
		browser.tabs.onUpdated.addListener(this.update);
		browser.tabs.onMoved.addListener(this.update);
		browser.tabs.onRemoved.addListener(this.update);
		browser.tabs.onReplaced.addListener(this.update);
		browser.tabs.onDetached.addListener(this.update);
		browser.tabs.onAttached.addListener(this.update);
		browser.tabs.onActivated.addListener(this.update);
		browser.windows.onFocusChanged.addListener(this.update);
		browser.windows.onCreated.addListener(this.update);
		browser.windows.onRemoved.addListener(this.update);
