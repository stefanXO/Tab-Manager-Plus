	...
	render:function(){
		...
		return React.DOM.div({},
			...
			React.DOM.div({className:"window"},
				...
				React.DOM.div({className:"icon windowaction "+this.state.Layout,title:"Add Window",onClick:this.changeLayout}),
				...
				React.DOM.div({className:"icon windowaction new",title:"Toggle Tabs",onClick:this.addWindow})
			)
		)
	},
