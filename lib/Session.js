"use strict";var Session = React.createFactory(React.createClass({
	...
	windowClick: async function windowClick(e) {var _this2 = this;
		e.stopPropagation();
		...
		filter(function (key) {return whitelistWindow.includes(key);}).
		...
		for (var i = 0; i < this.props.window.tabs.length; i++) {
			...
			filter(function (key) {return whitelistTab.includes(key);}).
			reduce(function (obj, key) {
