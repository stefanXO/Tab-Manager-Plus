"use strict";var TabOptions = React.createFactory(React.createClass({
	...
	logo: function logo() {
		...
		React.DOM.h2({}, "Tab Manager Plus 5.0.4")];
	...
	optionsSection: function optionsSection() {
		...
		React.DOM.div({ className: "option-description" }, "Allows you to save windows as sessions ( saved windows ). You can restore these saved windows later on. The restored windows won't have the history restored. This features is currently in beta.",
		React.DOM.br({}),
