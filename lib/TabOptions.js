"use strict";var TabOptions = React.createFactory(React.createClass({
	...
	optionsSection: function optionsSection() {
		...
		React.DOM.div({ className: "toggle-box" },
		React.DOM.div({ className: "toggle-box" },
		React.DOM.label({ className: "textlabel", htmlFor: "session_export", style: { "white-space": "pre", "line-height": "2rem" } }, React.DOM.h4({}, "Export/Backup Sessions")),
		...
		React.DOM.div({ className: "toggle-box" },
		React.DOM.div({ className: "toggle-box" },
		React.DOM.label({ className: "textlabel", htmlFor: "session_import", style: { "white-space": "pre", "line-height": "2rem" } }, React.DOM.h4({}, "Import/Restore Sessions")),
		...
		React.DOM.div({ className: "option-description" }, "With the right mouse button you can select tabs"),
		React.DOM.h4({}, "Shift+Right mouse button"),
		React.DOM.div({ className: "option-description" }, "While holding shift, and pressing the right mouse button you can select all tabs between the last selected tab and the current one"),
		...
		React.DOM.h4({}, "[Enter / Return] button"),
		React.DOM.div({ className: "option-description" }, "With the return button you can switch to the currently selected tab, or move multiple selected tabs to a new window"),
		))];
