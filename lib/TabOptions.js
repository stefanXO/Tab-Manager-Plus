"use strict";var TabOptions = React.createFactory(React.createClass({
	...
	logo: function logo() {
		...
		React.DOM.h2({}, "Tab Manager Plus 4.9.8")];
	...
	optionsSection: function optionsSection() {
		...
		React.DOM.div({ className: "option-description" }, "With this option enabled, you will only have 1 open Chrome window per monitor at all times. When you switch to another Chrome window, the other windows will be minimized to the tray automatically.",
		React.DOM.br({}),
