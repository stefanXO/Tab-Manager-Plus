var Tab = React.createFactory(React.createClass({
	...
	render:function(){
		...
		return React.DOM.div({
			className:"icon tab "+(this.props.selected?"selected ":"")+(this.props.layout=="vertical"?"full ":"")+(this.props.tab.incognito?"incognito ":"")+(this.state.draggingOver||""),
			style:{
				backgroundImage:this.props.tab.favIconUrl?("url("+this.props.tab.favIconUrl+")"):"",
