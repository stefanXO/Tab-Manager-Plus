	...
	render: function render() {var _this = this;
		...
		if (!hideWindow) {
			if (!!this.props.tabactions) {
				...
				this.props.sessionsFeature?React.DOM.div({ className: "icon tabaction save " + (this.props.layout.indexOf("blocks") > -1 ? "" : "windowaction"), title: "Save this window for later\nWill close " + tabs.length + " tabs and save the window for later. Please note : The saved tabs will lose their history.", onClick: this.save, onMouseEnter: this.props.hoverIcon }):false,
